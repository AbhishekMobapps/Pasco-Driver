...
@HiltViewModel
class LoyaltyCodeUseModelView @Inject constructor(
    ...
    fun cancelBooking(acceptBody: LoyaltyCodeUseBody, activity: Activity) {
        //progressDialog.start(activity.getString(R.string.please_wait))
        progressIndicator.value = true
        repository.loyaltyCodeUse(acceptBody).subscribeOn(Schedulers.io()).observeOn(
