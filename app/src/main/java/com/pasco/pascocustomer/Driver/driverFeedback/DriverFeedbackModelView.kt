...
@HiltViewModel
class DriverFeedbackModelView @Inject constructor(
    ...
    fun cancelBooking(acceptBody: DriverFeedbackBody, activity: Activity, progressDialog: CustomProgressDialog) {
        progressDialog.start(activity.getString(R.string.please_wait))
        progressIndicator.value = true
        repository.feedbackDriver(acceptBody).subscribeOn(Schedulers.io()).observeOn(
